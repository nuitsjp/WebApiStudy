...
${nuget_cmd} install src/HelloWebApi.Service/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/HelloWebApi.Service.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/HelloWebApi.Service.dll \
-recurse:'src/HelloWebApi.Service/*.cs' \
-doc:bin/HelloWebApi.Service.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/HelloWebApi.Service.dll was created successfully"
fi
